...
def make_scaffold_contract_prompt(
    ...
    *,
    ...
    return (
        ...
        "   Preferred benchmark-agnostic implementation: in evaluation.sh call `$AIDER_FSM_PYTHON -m runner.generic_evaluation`.\n"
        ...
        "  - Generic rollout (writes rollout.json + samples JSONL): `$AIDER_FSM_PYTHON -m runner.generic_rollout`\n"
        "  - Generic evaluation (runs doc/CI hints + writes hints_used.json + metrics.json): `$AIDER_FSM_PYTHON -m runner.generic_evaluation`\n"
