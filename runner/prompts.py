...
def make_scaffold_contract_prompt(
    ...
    *,
    ...
    return (
        ...
        "     - .aider_fsm/venv/bin/python -m pip install -e \".[testing]\"\n"
        "   env:\n"
        ...
        "    - `python3 -m venv .aider_fsm/venv`\n"
        "    - `.aider_fsm/venv/bin/python -m pip install -U pip`\n"
        "    - If `requirements.txt` exists: `.aider_fsm/venv/bin/python -m pip install -r requirements.txt`\n"
        "      Else: `.aider_fsm/venv/bin/python -m pip install -e .`\n"
